...
def getthresholdedimg(im):
	...
	cv.InRangeS(imghsv,cv.Scalar(0,100,100),cv.Scalar(1,255,255),imgyellow)	# Select a range of yellow color
	cv.InRangeS(imghsv,cv.Scalar(100,100,100),cv.Scalar(160,255,255),imgblue)	# Select a range of blue color
